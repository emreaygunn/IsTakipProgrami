<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="Cagrilar.aspx.cs" Inherits="IsTakipProgramı.Cagrilar" ValidateRequest="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="pnlKullaniciYetki" runat="server">
        <asp:Panel ID="pnlCagrilar" runat="server">
                            ...
                            <asp:Repeater ID="rptCagrilar" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td class="center">
                                            <a class="btn btn-warning" href="Cagrilar.aspx?id=<%#Eval("CagriID") %>">
                                                <i class="icon-edit icon-white"></i>
                                                Düzelt                                            
                                            </a>
                                            <a class="<%# AktifKontrol(Eval("Aktif").ToString(),"1") %>" href="Cagrilar.aspx?s=<%#Eval("CagriID") %>">
